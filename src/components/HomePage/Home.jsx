    ...
    {/* <span className="fase absolute bottom-[0] left-[300px] contents-['hiii'] blur-3xl bg-opacity-50 h-[300px] w-[200px] bg-[#f46728] z-51 rounded-full "></span> */}
      <section id="homePage" className="flex -z-10 flex-col h-full bg-homebg">
        ...
        <ul className="box-area -z-20 overflow-hidden w-full h-full absolute left-0 top-0">
          {/* 1 */}
          <li className="absolute w-[25vw] h-[25vw] sm:w-[13vw] sm:h-[13vh] sm:top-[25vh] sm:left-[7vw] top-[10vh] left-[10vw] opacity-70 block">
            <img src={shape9} alt="shape" />
          </li>
          {/* 2 */}
          <li className="absolute w-[20vw] h-[20vh] top-[10vh] left-[75vw] sm:w-[12vw] sm:h-[12vh] sm:top-[25vh] sm:left-[80vw] opacity-70 block">
            <img src={shape7} alt="shape" />
          </li>
          {/* 3 */}
          <li className="absolute w-[20vw] h-[20vw] top-[55vh] left-[75vw] sm:w-[10vw] sm:h-[10vh] sm:left-[70vw] sm:top-[45vh] opacity-70 block">
          ...
          {/* 5 */}
          <li className="absolute w-[20vw] h-[20vw] top-[55vh] left-[22vw] sm:h-[11vh] sm:w-[11vw] sm:left-[20vw] sm:top-[45vh] opacity-70 block">
            <img src={shape5} alt="shape" />
          </li>
          {/* 6 */}
          <li className="absolute w-[15vw] h-[15vw] top-[42vh] left-[30vw] sm:h-[12vh] sm:w-[12vw] sm:left-[37vw] sm:top-[55vh] opacity-70 block">
            <img src={shape6} alt="shape" />
          </li>
          {/* 7 */}
          <li className="absolute w-[15vw] h-[15vw] top-[45vh] left-[60vw] sm:w-[12vw] sm:h-[12vh] sm:top-[55vh] sm:left-[55vw] md:w-[7vw] md:h-[7vw] opacity-70 block">
