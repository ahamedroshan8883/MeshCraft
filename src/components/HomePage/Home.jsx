    ...
    {/* <span className="fase absolute bottom-[0] left-[300px] contents-['hiii'] blur-3xl bg-opacity-50 h-[300px] w-[200px] bg-[#f46728] z-51 rounded-full "></span> */}
      <section id="homePage" className="flex -z-10 flex-col items-center h-full justify-center bg-homebg">
        ...
        <ul className="box-area absolute overflow-hidden w-full h-full top-0 left-0">
          <li className="w-[80px] h-[80px] sm:w-[70px] sm:h-[70px] absolute sm:top-[130px] sm:left-[25%] top-[40px] left-[10%] block animate-[animate_20s_linear_infinite]">
            <img src={shape1} alt="shape" />
          </li>
          <li className="w-[70px] h-[70px] absolute top-[230px] left-[15%] sm:left-[20%] sm:top-[300px] block animate-[animate_20s_linear_infinite]">
            <img src={shape2} alt="shape" />
          </li>
          <li className="w-[100px] h-[100px] absolute top-[180px] left-[65%] sm:top-[270px] sm:left-[60%] block animate-[animate_20s_linear_infinite]">
            <img src={shape3} alt="shape" />
          </li>
          <li className="w-[90px] h-[90px] absolute top-[50px] left-[40%] sm:top-[60px] sm:w-[100px] sm:h-[100px] block animate-[animate_20s_linear_infinite]">
            <img src={shape4} alt="shape" />
          </li>
          <li className="w-[40px] h-[40px] absolute top-[80px] left-[80%] sm:top-[120px] sm:w-[50px] sm:h-[50px] sm:left-[60%] block animate-[animate_20s_linear_infinite]">
            <img src={shape5} alt="shape" />
          </li>
          <li className="w-[110px] h-[110px] absolute top-[270px] left-[34%] sm:top-[300px]  block animate-[animate_20s_linear_infinite]">
        ...
        model-type-icons box-border  h-[30vh] px-2 py-4 flex flex-wrap justify-center gap-3 sm:gap-16">
          {software.map(item=>
